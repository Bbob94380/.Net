rootModule.controller("transactionAndSalesController", ["$scope", "$uibModal", "$http", "$rootScope", "$filter", "filterTableListService", function ($scope, $uibModal, $http, $rootScope, $filter, filterTableListService) {
