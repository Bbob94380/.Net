...
rootHOModule.controller("refundController", ["$scope", "$uibModal", "$http", "$rootScope", function ($scope, $uibModal, $http, $rootScope) {
    ...
    $scope.openRefundInfoPopup = function (refundType) {
    ...
    $scope.createNewDryRefund = function () {

        var modalInstance;

        modalInstance = $uibModal.open({
            animate: true,
            templateUrl: '/Pages/POSManager/POS/Refund/Views/createNewDryRefundPopup.html',
            controller: 'createNewDryRefundPopupController',
            scope: $scope,
            windowClass: 'show',
            resolve: {
                data: function () {
